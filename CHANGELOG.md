...
- Added native four-target binary release archives, checksum manifests, and draft/public release verification using the release ID returned directly by draft creation; assets are re-verified immediately before publication. The release-ID selector is included and regression-tested in this version.
